        ...
        <div className="min-h-screen flex justify-center items-baseline pt-12 bg-gray-100">
            <div className="bg-white p-10 rounded-lg shadow-lg w-112.5">
                ...
                <div className="mt-8">
                    ...
                    <input type="email" className="w-full border border-gray-300 rounded px-3 py-2 mt-1" />
                </div>

                <div className="mt-6">
                    <label htmlFor="password" className="text-sm font-medium">Password</label>
                    <input type="password" className="w-full border border-gray-300 rounded px-3 py-2 mt-1" />
                </div>
